...
#define SPI_Master_Clock					RCC_AHB1Periph_SPI2
...
#define SPI_Slave_Clock						RCC_AHB1Periph_SPI1
...
static unit8_t Revice_Data_Slave(SPI_InitTypeDef *SPIx);
static unit8_t Send_Data(SPI_InitTypeDef* SPIx,uint_t data);
